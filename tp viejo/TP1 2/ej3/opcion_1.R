...
source("C:/Users/fedep/OneDrive/Documentos/TD VI/TP1/src/provided_functions.R")
...
run_experiment <- function(datasets_to_pred, filepath) {
  ...
  for (dtp in datasets_to_pred) {
    for (impute in c("Yes", "No")) {
      for (prop_NAs in seq(0.1, 0.9, by = 0.2)) {
...
datasets_to_pred <- list(
  load_df("C:/Users/fedep/OneDrive/Documentos/TD VI/TP1/src/data/customer_churn.csv", "Churn", "churn"), # Source: https://archive.ics.uci.edu/dataset/563/iranian+churn+dataset
  load_df("C:/Users/fedep/OneDrive/Documentos/TD VI/TP1/src/data/heart.csv", "Heart", "HeartDisease"),    # Source: https://www.kaggle.com/datasets/arnabchaki/data-science-salaries-2023
  load_df("C:/Users/fedep/OneDrive/Documentos/TD VI/TP1/src/data/HousePricePrediction.csv","House","Mayor_2")
  
  )

# Run the experiment
if (RERUN_EXP ==  TRUE) {
  run_experiment(datasets_to_pred, "C:/Users/fedep/OneDrive/Documentos/TD VI/TP1/src/outputs/tables/sample_exp.txt")
}

# Plot the experiment results
plot_exp_results( "C:/Users/fedep/OneDrive/Documentos/TD VI/TP1/src/outputs/tables/sample_exp.txt", "C:/Users/fedep/OneDrive/Documentos/TD VI/TP1/src/outputs/plots/sample_exp.jpg", width=5, height=4)
