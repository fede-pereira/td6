...
N_THREADS <- 5     # Define the number of threads for parallel processing
...
source("~/Downloads/TP1 2/src/provided_functions.R")
...
# Run the experiment
if (RERUN_EXP ==  TRUE) {
  run_experiment(datasets_to_pred, "/Users/ezequielkaplan/Downloads/TP1\ 2/src/outputs/tables/ex1_exp.txt")
}

# Plot the experiment results
plot_exp_results( "/Users/ezequielkaplan/Downloads/TP1\ 2/src/outputs/tables/ex1_exp.txt", "/Users/ezequielkaplan/Downloads/TP1\ 2/src/outputs/plots/ex1_exp.jpg", width=5, height=4)
