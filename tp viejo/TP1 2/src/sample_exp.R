...
datasets_to_pred <- list(
  ...
  load_df("/Users/ezequielkaplan/Downloads/TP1\ 2/src/data/House.csv", "House", "SalePrice") 
)

# Run the experiment
if (RERUN_EXP ==  TRUE) {
  run_experiment(datasets_to_pred, "/Users/ezequielkaplan/Downloads/TP1\ 2/src/outputs/tables/sample_exp2.txt")
}

# Plot the experiment results
plot_exp_results( "/Users/ezequielkaplan/Downloads/TP1\ 2/src/outputs/tables/sample_exp2.txt", "/Users/ezequielkaplan/Downloads/TP1\ 2/src/outputs/plots/sample_exp2.jpg", width=5, height=4)
